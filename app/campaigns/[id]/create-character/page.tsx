  ...
  return (
    <main>
      ...
      <Form action={createCharacterByCampaignID} close={'/campaigns/' + campaignID}>
        ...
        <FormItemSelect name="character_type" label="Select character type" classNameLabel='text-text' options={[{ key: "Player", value: "Player" }, { key: "NPC", value: "NPC" }, { key: "Enemy", value: "Enemy" }, { key: "Pet", value: "Pet" }]} defaultValue='Player' visible={isDM} />
        ...
        <FormItemInput name="background" label="Choose your background" maxLength={100} />
