    ...
    return (
        <div className="inline-block relative">
            <input
                ...
                className={cn("bg-transparent absolute placeholder:text-white/[.6] placeholder:font-semibold top-0 left-0 w-auto min-w-[15px] max-w-[400px] mx-1 ring-offset-transparent focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-transparent focus-visible:ring-offset-2 outline-hidden", className)}
                {...props}
            />
